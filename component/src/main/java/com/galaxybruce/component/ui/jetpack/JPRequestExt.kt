 ...
 *
 *  注意：[JPBaseRequest] 与 [JPRequestExt]的区别：
...
suspend fun <T> JPBaseRequest.doSuspendTask(
                                doTaskCallback: ((T) -> Unit, (String) -> Unit) -> Unit,
 ...
 *
 */
fun <T: IAppBean> JPBaseRequest.request(
    block: suspend () -> T,
    successCallback: suspend (T) -> Unit = {},
    errorCallback: suspend (Throwable) -> Unit = {},
