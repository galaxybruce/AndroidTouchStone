 ...
 */
public class KWCrossProcessSPContentProvider extends ContentProvider {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        if (type.equals(TYPE_GET_ALL)) {
            Map<String, ?> all = KWCrossProcessSPHelperImpl.getAll(getContext());
            if (all == null) {
                return null;
            }
    ...
    public String getType(Uri uri) {
        ...
        if (type.equals(TYPE_CONTAIN)) {
            return KWCrossProcessSPHelperImpl.contains(getContext(), key) + "";
        }
        return KWCrossProcessSPHelperImpl.get(getContext(), key, type) + "";
    }
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        if (obj != null) {
            KWCrossProcessSPHelperImpl.save(getContext(), key, obj);
        }
        return null;
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        if (type.equals(TYPE_CLEAN)) {
            KWCrossProcessSPHelperImpl.clear(getContext());
            return 0;
        }
        String key = path[2];
        if (KWCrossProcessSPHelperImpl.contains(getContext(), key)) {
            KWCrossProcessSPHelperImpl.remove(getContext(), key);
        }
        return 0;
    }
