 ...
 */
class AppProcessSPHelperImpl {

    private static final String MAIN_SP_NAME = "kw_cross_process_file";
    ...
    private static SharedPreferences getSP(Context context) {
        ...
        return context.getSharedPreferences(MAIN_SP_NAME, Context.MODE_PRIVATE);
    }
